...
console.log(
  "isTypesmaller === isTypeUpper ",
  typeof "abcdef" === typeof "ABCDEF"
); // True
...
console.log(
  "isTypesmaller !== isTypeNumber ",
  typeof "abcdef" !== typeof 123456
); // True
...
console.log(
  `(${isBoolDay1} == ${isBoolDay2}) OR (${isBoolDay1} == ${isBoolDay3})`
);
...
console.log("Test 8");
console.log(
  `(${isBoolDay1} == ${isBoolDay1}) AND (${isBoolDay3} == ${isBoolDay3})`
);
...
console.log("Test 9");
console.log(
  `NOT(${isBoolDay1} == ${isBoolDay2}) AND NOT(${isBoolDay1} == ${isBoolDay3})`
);
console.log(!(isBoolDay1 == isBoolDay2) && !(isBoolDay1 == isBoolDay3));
...
console.log("Test 10");
console.log(
  `NOT((${isBoolDay1} == ${isBoolDay2}) AND (${isBoolDay3} == ${isBoolDay3}))`
);
